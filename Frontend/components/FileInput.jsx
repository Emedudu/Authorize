  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      ...
      >
        <label
          for={id}
          class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 opacity-60 hover:opacity-90"
        >
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
              {id == "image" ? "Book Cover Image" : "Book Content"}
            </p>
            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
